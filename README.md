...
> 三小時工作坊講義 ｜ 對象：完全沒寫過程式、會用電腦、有 ChatGPT **Pro** 帳號的老師與一般人
> 講師：大乃老師（陳乃誠）
...
- 費用：含在你的 **ChatGPT Pro** 訂閱裡，登入即用，不用另外辦 API 金鑰。
